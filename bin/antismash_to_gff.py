...
BGC = namedtuple("BGC", "contig_name bgc_name bgc_type prod_categories start end orfs")
    ...
    with open(json_file) as json_handle:
        ...
        for bgc_entry in json_dict:
            ...
            for region in regions:
                ...
                prod_categories = "|".join(region.get("product_categories",[]))
                bgc_orfs = []
...
def build_gff(regions_json, antismash_version):
    ...
    for bgc in bgc_regions:
        ...
        yield [
            ...
            ".",
            ".",
            f"ID={bgc.bgc_name};TYPE={bgc.bgc_type};PRODUCT_CATEGORIES={bgc.prod_categories}",
        ]
        orf: ORF
        for orf in bgc.orfs:
            ninth_column = [
